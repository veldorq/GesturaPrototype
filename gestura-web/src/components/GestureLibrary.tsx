  ...
  return (
    <section className="relative py-32 px-6 bg-[#0a0a0a] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <h2 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-white via-purple-200 to-cyan-300 bg-clip-text text-transparent">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {gestures.map((gesture, index) => (
            ...
            >
              ...
              {/* Icon */}
              <div className="text-6xl mb-4">{gesture.icon}</div>
